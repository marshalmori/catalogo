...
# Cria um novo usuário através da página de cadastro
...
def createGoogleUser(login_session):
...
def showCategory():
    ...
    if 'username' not in login_session:
        return render_template('category/public_category.html', categories=categories)
    else:
